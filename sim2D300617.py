...
#        xVelocity[nx-1]=U
    elapsed +=timeStep
    viewer.plot(filename="VFCsim/sim50/phi%d.png" % elapsed)
    viewer2.plot(filename="VFCsim/sim50/XVelocity%d.png" % elapsed)
    viewer4.plot(filename="VFCsim/sim50/pressure%d.png" % elapsed)
    viewer3.plot(filename="VFCsim/sim50/YVelocity%d.png" % elapsed)
    TSVViewer(vars=(phi, xVelocity, yVelocity, pressure,beta)).plot(filename="VFCsim/sim50/essaidonne%d.tsv" % elapsed)
    print(elapsed)
