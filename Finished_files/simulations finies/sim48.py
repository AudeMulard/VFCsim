...
#        xVelocity[nx-1]=U
    elapsed +=timeStep
    viewer.plot(filename="phi48_%d.png" % elapsed)
    viewer2.plot(filename="XVelocity48_%d.png" % elapsed)
    viewer4.plot(filename="YVelocity48_%d.png" % elapsed)
    viewer3.plot(filename="pressure48_%d.png" % elapsed)
    TSVViewer(vars=(phi, xVelocity, yVelocity, pressure,beta)).plot(filename="essaidonne48_%d.tsv" % elapsed)
    print(elapsed)
