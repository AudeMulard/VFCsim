...
# -*- coding: utf-8 -*-
"""
Created on Thu Jun  1 09:33:31 2017
...
xVelocityEq = ImplicitSourceTerm() + pressure.grad.dot([1.,0.])
yVelocityEq = ImplicitSourceTerm() + pressure.grad.dot([0., 1.])
...
xVelocity.constrain(U, mesh.facesRight | mesh.facesLeft | mesh.facesBottom)
xVelocity.constrain(U, mesh.facesTop)
yVelocity.constrain(U, mesh.exteriorFaces)
...
#    velocity[..., mesh.exteriorFaces.value]=U
