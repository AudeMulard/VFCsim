...
#        ap[:] = xmat.takeDiagonal()
        ...
        xVelocity[nx-1]=U
    elapsed +=timeStep
    viewer.plot(filename="phi%d_79.png" % elapsed)
    viewer2.plot(filename="XVelocity%d_79.png" % elapsed)
    viewer4.plot(filename="pressure%d_79.png" % elapsed)
    viewer3.plot(filename="YVelocity%d_79.png" % elapsed)
    TSVViewer(vars=(phi, xVelocity, yVelocity, pressure,beta)).plot(filename="essaidonne%d_79.tsv" % elapsed)
    print(elapsed)
