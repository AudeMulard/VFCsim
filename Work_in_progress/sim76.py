...
#        ap[:] = xmat.takeDiagonal()
        ...
        xVelocity[nx-1]=U
    elapsed +=timeStep
    viewer.plot(filename="phi%d_76.png" % elapsed)
    viewer2.plot(filename="XVelocity%d_76.png" % elapsed)
    viewer4.plot(filename="pressure%d_76.png" % elapsed)
    viewer3.plot(filename="YVelocity%d_76.png" % elapsed)
    TSVViewer(vars=(phi, xVelocity, yVelocity, pressure,beta)).plot(filename="essaidonne%d_76.tsv" % elapsed)
