...
#        ap[:] = xmat.takeDiagonal()
        ...
        xVelocity[nx-1]=U
    elapsed +=timeStep
    viewer.plot(filename="phi%d_82.png" % elapsed)
    viewer2.plot(filename="XVelocity%d_82.png" % elapsed)
    viewer4.plot(filename="pressure%d_82.png" % elapsed)
    viewer3.plot(filename="YVelocity%d_82.png" % elapsed)
    TSVViewer(vars=(phi, xVelocity, yVelocity, pressure,beta)).plot(filename="essaidonne%d_82.tsv" % elapsed)
